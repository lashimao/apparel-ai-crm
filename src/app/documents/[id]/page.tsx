  ...
  return (
    <AppShell>
      <Space direction="vertical" size={20} style={{ width: '100%' }}>
        ...
        />
        <Alert showIcon type="warning" message="单证可由 AI 生成草稿，但金额、箱规、贸易条款、收发货人、唛头必须人工校验。" />
        <Row gutter={[16, 16]}>
          <Col xs={24} xl={15}>
            <Card bordered={false} title="单证信息">
            ...
            <Card bordered={false} title="单证预览" style={{ marginTop: 16 }}>
          ...
          <Col xs={24} xl={9}>
            <Card bordered={false} title="校验流程"><Steps direction="vertical" current={2} items={[{ title: '选择模板' }, { title: '订单数据填充' }, { title: 'AI 草稿/OCR' }, { title: '人工校验' }, { title: '归档/发送' }]} /></Card>
            <Card bordered={false} title={<Space><FileDoneOutlined /> 校验清单</Space>} style={{ marginTop: 16 }}><Space direction="vertical"><Text>金额与币种一致</Text><Text>箱规/毛净重完整</Text><Text>收发货人准确</Text><Text>贸易条款和目的港准确</Text><Text>唛头和备注无误</Text></Space></Card>
          </Col>
        </Row>
      </Space>
    </AppShell>
